...
#' \describe{
#' \item{fullGenome }{ classifies each region as either being exon, intron or intragenic.}
#' \item{codingGenome }{ classfies the regions as being promoter, exon, intro, 5UTR, 3UTR or intragenic.}
#' }
#'@keywords datasets
