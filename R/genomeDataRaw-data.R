...
#'
#' 10kb region from chr21 processed for 31 RNA-seq samples described in \link{genomeInfo}. The TopHat BAM files are included in the package and this is the output of \link{loadCoverage} applied to it with \code{cutoff=NULL}. For more information check the example of \link{loadCoverage}.
#'
#' @references
