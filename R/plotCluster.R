...
#'
#' ## The F-stat cutoff applied to F-stats leads to 5 different segments passing the cutoff.
...
#' 
#' ## They are the 6 different DERs we see in cluster 5 as shown in plotCluster(idx=7, ...)
#'
