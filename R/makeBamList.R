...
#'
#' For a group of samples this function creates the list of paths to the BAM files which can then be used in \link{loadCoverage}.
#' 
...
#'
#' @return A vector with the full paths to the BAM files and sample names stored as the vector names.
#'
...
makeBamList <- function(datadir=NULL, sampledirs=NULL, samplepatt=NULL, bamterm="accepted_hits.bam") {
