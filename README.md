...
RNA-seq data at base-pair resolution_. https://github.com/lcolladotor/derfinder - R package version 1.1.14, <URL:
...
@Manual{,
    ...
    note = {https://github.com/lcolladotor/derfinder - R package version 1.1.14},
}
