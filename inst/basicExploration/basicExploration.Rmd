...
`r ifelse(makeBestClusters, paste("Below are the best", nBestClusters, "region clusters ordered by cluster area."), "No plots were generated as requested.")`
...
The F-statistic cutoff used was `r optionsStats$cutoffFstat` and type of cutoff used was `r optionsStats$cutoffType`.
